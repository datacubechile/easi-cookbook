"""
THIS HAS BEEN MODIFIED FROM THIS VERSION: https://github.com/DBarthe/geohash
...
def encode_from_xy(x, y, crs='epsg:32619', precision=12):
    """
    Returns a geohash from x and y
    :param x: x
    :param y: y
